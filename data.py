...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        ax[0][i].set_title(str(data1[3].values[0]) + ":" + str(data1[2]) + " flip;" + str(class_num) + "-" + str(
            ProblemClasses.class_name[int(class_num)]))
        # ax[0][i].set_axis_off()
        ...
        ax[1][i].set_title(str(data1[3].values[0]) + ":" + str(data1[2]) + " flip;" + str(class_num) + "-" + str(
            ProblemClasses.class_name[int(class_num)]))
        ax[1][i].set_axis_off()
